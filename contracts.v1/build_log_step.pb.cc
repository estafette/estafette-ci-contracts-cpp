...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "contracts.v1/build_log_step.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::Descriptor* BuildLogStep::descriptor() {
  ::protobuf_contracts_2ev1_2fbuild_5flog_5fstep_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_contracts_2ev1_2fbuild_5flog_5fstep_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const BuildLogStep& BuildLogStep::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_contracts_2ev1_2fbuild_5flog_5fstep_2eproto::scc_info_BuildLogStep.base);
...
::google::protobuf::Metadata BuildLogStep::GetMetadata() const {
  protobuf_contracts_2ev1_2fbuild_5flog_5fstep_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_contracts_2ev1_2fbuild_5flog_5fstep_2eproto::file_level_metadata[kIndexInFileMessages];
}
