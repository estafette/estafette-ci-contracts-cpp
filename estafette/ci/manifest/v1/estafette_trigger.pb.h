...
#ifndef PROTOBUF_INCLUDED_estafette_2fci_2fmanifest_2fv1_2festafette_5ftrigger_2eproto
#define PROTOBUF_INCLUDED_estafette_2fci_2fmanifest_2fv1_2festafette_5ftrigger_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5ftrigger_2eproto 
...
class EstafetteTrigger : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:estafette.ci.manifest.v1.EstafetteTrigger) */ {
 public:
  EstafetteTrigger();
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafettePipelineTrigger& _internal_pipeline() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteReleaseTrigger& _internal_release() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteGitTrigger& _internal_git() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteDockerTrigger& _internal_docker() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteCronTrigger& _internal_cron() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafettePubSubTrigger& _internal_pub_sub() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteTriggerBuildAction& _internal_build_action() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteTriggerReleaseAction& _internal_release_action() const;
  public:
 ...
 private:
  ...
  friend struct ::protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5ftrigger_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::estafette::ci::manifest::v1::EstafettePipelineTrigger& EstafetteTrigger::_internal_pipeline() const {
  return *pipeline_;
}
inline const ::estafette::ci::manifest::v1::EstafettePipelineTrigger& EstafetteTrigger::pipeline() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafettePipelineTrigger*>(
...
inline const ::estafette::ci::manifest::v1::EstafetteReleaseTrigger& EstafetteTrigger::_internal_release() const {
  return *release_;
}
inline const ::estafette::ci::manifest::v1::EstafetteReleaseTrigger& EstafetteTrigger::release() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteReleaseTrigger*>(
...
inline const ::estafette::ci::manifest::v1::EstafetteGitTrigger& EstafetteTrigger::_internal_git() const {
  return *git_;
}
inline const ::estafette::ci::manifest::v1::EstafetteGitTrigger& EstafetteTrigger::git() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteGitTrigger*>(
...
inline const ::estafette::ci::manifest::v1::EstafetteDockerTrigger& EstafetteTrigger::_internal_docker() const {
  return *docker_;
}
inline const ::estafette::ci::manifest::v1::EstafetteDockerTrigger& EstafetteTrigger::docker() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteDockerTrigger*>(
...
inline const ::estafette::ci::manifest::v1::EstafetteCronTrigger& EstafetteTrigger::_internal_cron() const {
  return *cron_;
}
inline const ::estafette::ci::manifest::v1::EstafetteCronTrigger& EstafetteTrigger::cron() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteCronTrigger*>(
...
inline const ::estafette::ci::manifest::v1::EstafettePubSubTrigger& EstafetteTrigger::_internal_pub_sub() const {
  return *pub_sub_;
}
inline const ::estafette::ci::manifest::v1::EstafettePubSubTrigger& EstafetteTrigger::pub_sub() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafettePubSubTrigger*>(
...
inline const ::estafette::ci::manifest::v1::EstafetteTriggerBuildAction& EstafetteTrigger::_internal_build_action() const {
...
inline const ::estafette::ci::manifest::v1::EstafetteTriggerBuildAction& EstafetteTrigger::build_action() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteTriggerBuildAction*>(
...
inline const ::estafette::ci::manifest::v1::EstafetteTriggerReleaseAction& EstafetteTrigger::_internal_release_action() const {
...
inline const ::estafette::ci::manifest::v1::EstafetteTriggerReleaseAction& EstafetteTrigger::release_action() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteTriggerReleaseAction*>(
...
#endif  // PROTOBUF_INCLUDED_estafette_2fci_2fmanifest_2fv1_2festafette_5ftrigger_2eproto
