...
#ifndef PROTOBUF_INCLUDED_estafette_2fci_2fmanifest_2fv1_2festafette_5fversion_2eproto
#define PROTOBUF_INCLUDED_estafette_2fci_2fmanifest_2fv1_2festafette_5fversion_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5fversion_2eproto 
...
class EstafetteVersion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:estafette.ci.manifest.v1.EstafetteVersion) */ {
 public:
  EstafetteVersion();
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteSemverVersion& _internal_semver() const;
  public:
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteCustomVersion& _internal_custom() const;
  public:
 ...
 private:
  ...
  friend struct ::protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5fversion_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::estafette::ci::manifest::v1::EstafetteSemverVersion& EstafetteVersion::_internal_semver() const {
  return *semver_;
}
inline const ::estafette::ci::manifest::v1::EstafetteSemverVersion& EstafetteVersion::semver() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteSemverVersion*>(
...
inline const ::estafette::ci::manifest::v1::EstafetteCustomVersion& EstafetteVersion::_internal_custom() const {
  return *custom_;
}
inline const ::estafette::ci::manifest::v1::EstafetteCustomVersion& EstafetteVersion::custom() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteCustomVersion*>(
...
#endif  // PROTOBUF_INCLUDED_estafette_2fci_2fmanifest_2fv1_2festafette_5fversion_2eproto
