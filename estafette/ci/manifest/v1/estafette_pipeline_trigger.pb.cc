...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::manifest::v1::EstafettePipelineTrigger, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::manifest::v1::EstafettePipelineTrigger, event_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::manifest::v1::EstafettePipelineTrigger, status_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::manifest::v1::EstafettePipelineTrigger, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::manifest::v1::EstafettePipelineTrigger, branch_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::estafette::ci::manifest::v1::_EstafettePipelineTrigger_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "estafette/ci/manifest/v1/estafette_pipeline_trigger.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "estafette/ci/manifest/v1/estafette_pipeline_trigger.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* EstafettePipelineTrigger::descriptor() {
  ::protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5fpipeline_5ftrigger_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5fpipeline_5ftrigger_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const EstafettePipelineTrigger& EstafettePipelineTrigger::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5fpipeline_5ftrigger_2eproto::scc_info_EstafettePipelineTrigger.base);
...
::google::protobuf::Metadata EstafettePipelineTrigger::GetMetadata() const {
  protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5fpipeline_5ftrigger_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fmanifest_2fv1_2festafette_5fpipeline_5ftrigger_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::estafette::ci::manifest::v1::EstafettePipelineTrigger* Arena::CreateMaybeMessage< ::estafette::ci::manifest::v1::EstafettePipelineTrigger >(Arena* arena) {
