...
#ifndef PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto
#define PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto 
...
class ReleaseLog : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:estafette.ci.contracts.v1.ReleaseLog) */ {
 public:
  ReleaseLog();
  virtual ~ReleaseLog();
 ...
 private:
  ...
  friend struct ::protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::google::protobuf::Timestamp& ReleaseLog::_internal_inserted_at_time() const {
  return *inserted_at_time_;
}
inline const ::google::protobuf::Timestamp& ReleaseLog::inserted_at_time() const {
...
inline ::google::protobuf::Timestamp* ReleaseLog::release_inserted_at_time() {
...
inline ::google::protobuf::Timestamp* ReleaseLog::mutable_inserted_at_time() {
...
inline void ReleaseLog::set_allocated_inserted_at_time(::google::protobuf::Timestamp* inserted_at_time) {
...
#endif  // PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto
