...
#ifndef PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2fbuild_2eproto
#define PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2fbuild_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_estafette_2fci_2fcontracts_2fv1_2fbuild_2eproto 
...
class Build : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:estafette.ci.contracts.v1.Build) */ {
 public:
  Build();
  virtual ~Build();
 ...
 private:
  ...
  friend struct ::protobuf_estafette_2fci_2fcontracts_2fv1_2fbuild_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::google::protobuf::Timestamp& Build::_internal_inserted_at_time() const {
  return *inserted_at_time_;
}
inline const ::google::protobuf::Timestamp& Build::inserted_at_time() const {
...
inline ::google::protobuf::Timestamp* Build::release_inserted_at_time() {
...
inline ::google::protobuf::Timestamp* Build::mutable_inserted_at_time() {
...
inline void Build::set_allocated_inserted_at_time(::google::protobuf::Timestamp* inserted_at_time) {
...
inline const ::google::protobuf::Timestamp& Build::_internal_updated_at_time() const {
  return *updated_at_time_;
}
inline const ::google::protobuf::Timestamp& Build::updated_at_time() const {
...
inline ::google::protobuf::Timestamp* Build::release_updated_at_time() {
...
inline ::google::protobuf::Timestamp* Build::mutable_updated_at_time() {
...
inline void Build::set_allocated_updated_at_time(::google::protobuf::Timestamp* updated_at_time) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
...
#endif  // PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2fbuild_2eproto
