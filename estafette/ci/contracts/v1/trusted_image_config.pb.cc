...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::TrustedImageConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::TrustedImageConfig, image_path_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::TrustedImageConfig, run_privileged_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::TrustedImageConfig, run_docker_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::TrustedImageConfig, allow_commands_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::TrustedImageConfig, injected_credential_types_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::estafette::ci::contracts::v1::_TrustedImageConfig_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "estafette/ci/contracts/v1/trusted_image_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "estafette/ci/contracts/v1/trusted_image_config.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* TrustedImageConfig::descriptor() {
  ::protobuf_estafette_2fci_2fcontracts_2fv1_2ftrusted_5fimage_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2ftrusted_5fimage_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const TrustedImageConfig& TrustedImageConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_estafette_2fci_2fcontracts_2fv1_2ftrusted_5fimage_5fconfig_2eproto::scc_info_TrustedImageConfig.base);
...
::google::protobuf::Metadata TrustedImageConfig::GetMetadata() const {
  protobuf_estafette_2fci_2fcontracts_2fv1_2ftrusted_5fimage_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2ftrusted_5fimage_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::estafette::ci::contracts::v1::TrustedImageConfig* Arena::CreateMaybeMessage< ::estafette::ci::contracts::v1::TrustedImageConfig >(Arena* arena) {
