...
namespace protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto {
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, repo_source_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, repo_owner_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, repo_name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, release_id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, steps_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseLog, inserted_at_time_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::estafette::ci::contracts::v1::_ReleaseLog_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "estafette/ci/contracts/v1/release_log.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "estafette/ci/contracts/v1/release_log.proto", &protobuf_RegisterTypes);
...
void ReleaseLog::InitAsDefaultInstance() {
  ::estafette::ci::contracts::v1::_ReleaseLog_default_instance_._instance.get_mutable()->inserted_at_time_ = const_cast< ::google::protobuf::Timestamp*>(
...
ReleaseLog::ReleaseLog()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto::scc_info_ReleaseLog.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* ReleaseLog::descriptor() {
  ::protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ReleaseLog& ReleaseLog::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto::scc_info_ReleaseLog.base);
...
void ReleaseLog::SerializeWithCachedSizes(
  ...
  if (this->has_inserted_at_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->_internal_inserted_at_time(), output);
  }
...
::google::protobuf::uint8* ReleaseLog::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_inserted_at_time()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        7, this->_internal_inserted_at_time(), deterministic, target);
  }
...
::google::protobuf::Metadata ReleaseLog::GetMetadata() const {
  protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5flog_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::estafette::ci::contracts::v1::ReleaseLog* Arena::CreateMaybeMessage< ::estafette::ci::contracts::v1::ReleaseLog >(Arena* arena) {
