...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_estafette_2fci_2fcontracts_2fv1_2fpagination_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Pagination;
}  // namespace protobuf_estafette_2fci_2fcontracts_2fv1_2fpagination_2eproto
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ListResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ListResponse, items_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ListResponse, pagination_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::estafette::ci::contracts::v1::_ListResponse_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "estafette/ci/contracts/v1/list_response.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "estafette/ci/contracts/v1/list_response.proto", &protobuf_RegisterTypes);
  ::protobuf_estafette_2fci_2fcontracts_2fv1_2fpagination_2eproto::AddDescriptors();
...
ListResponse::ListResponse()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_estafette_2fci_2fcontracts_2fv1_2flist_5fresponse_2eproto::scc_info_ListResponse.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* ListResponse::descriptor() {
  ::protobuf_estafette_2fci_2fcontracts_2fv1_2flist_5fresponse_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2flist_5fresponse_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ListResponse& ListResponse::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_estafette_2fci_2fcontracts_2fv1_2flist_5fresponse_2eproto::scc_info_ListResponse.base);
...
::google::protobuf::Metadata ListResponse::GetMetadata() const {
  protobuf_estafette_2fci_2fcontracts_2fv1_2flist_5fresponse_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2flist_5fresponse_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::estafette::ci::contracts::v1::ListResponse* Arena::CreateMaybeMessage< ::estafette::ci::contracts::v1::ListResponse >(Arena* arena) {
