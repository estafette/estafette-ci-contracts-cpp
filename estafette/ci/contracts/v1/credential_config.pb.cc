...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_CredentialConfig_AdditionalPropertiesEntry_DoNotUse;
}  // namespace protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto
...
::google::protobuf::internal::SCCInfo<1> scc_info_CredentialConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsCredentialConfig}, {
      &protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::scc_info_CredentialConfig_AdditionalPropertiesEntry_DoNotUse.base,}};
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig_AdditionalPropertiesEntry_DoNotUse, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig_AdditionalPropertiesEntry_DoNotUse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig_AdditionalPropertiesEntry_DoNotUse, key_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig_AdditionalPropertiesEntry_DoNotUse, value_),
  0,
  1,
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig, type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::CredentialConfig, additional_properties_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::estafette::ci::contracts::v1::_CredentialConfig_AdditionalPropertiesEntry_DoNotUse_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::estafette::ci::contracts::v1::_CredentialConfig_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "estafette/ci/contracts/v1/credential_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "estafette/ci/contracts/v1/credential_config.proto", &protobuf_RegisterTypes);
...
::google::protobuf::Metadata CredentialConfig_AdditionalPropertiesEntry_DoNotUse::GetMetadata() const {
  ::protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::file_level_metadata[0];
}
...
const ::google::protobuf::Descriptor* CredentialConfig::descriptor() {
  ::protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const CredentialConfig& CredentialConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::scc_info_CredentialConfig.base);
...
::google::protobuf::Metadata CredentialConfig::GetMetadata() const {
  protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2fcredential_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::estafette::ci::contracts::v1::CredentialConfig_AdditionalPropertiesEntry_DoNotUse* Arena::CreateMaybeMessage< ::estafette::ci::contracts::v1::CredentialConfig_AdditionalPropertiesEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::estafette::ci::contracts::v1::CredentialConfig_AdditionalPropertiesEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::estafette::ci::contracts::v1::CredentialConfig* Arena::CreateMaybeMessage< ::estafette::ci::contracts::v1::CredentialConfig >(Arena* arena) {
