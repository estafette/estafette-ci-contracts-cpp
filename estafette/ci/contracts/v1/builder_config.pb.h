...
#ifndef PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2fbuilder_5fconfig_2eproto
#define PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2fbuilder_5fconfig_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_estafette_2fci_2fcontracts_2fv1_2fbuilder_5fconfig_2eproto 
...
class BuilderConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:estafette.ci.contracts.v1.BuilderConfig) */ {
 public:
  BuilderConfig();
  ...
  ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::CredentialConfig >*
      mutable_credentials();
  ...
  const ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::CredentialConfig >&
      credentials() const;
  ...
  ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::TrustedImageConfig >*
  ...
  const ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::TrustedImageConfig >&
  ...
  private:
  const ::estafette::ci::manifest::v1::EstafetteManifest& _internal_manifest() const;
  public:
  ...
  private:
  const ::estafette::ci::contracts::v1::CiServerConfig& _internal_ci_server() const;
  public:
  ...
  private:
  const ::estafette::ci::contracts::v1::BuildParamsConfig& _internal_build_params() const;
  public:
  ...
  private:
  const ::estafette::ci::contracts::v1::ReleaseParamsConfig& _internal_release_params() const;
  public:
  ...
  private:
  const ::estafette::ci::contracts::v1::GitConfig& _internal_git() const;
  public:
  ...
  private:
  const ::estafette::ci::contracts::v1::BuildVersionConfig& _internal_build_version() const;
  public:
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::CredentialConfig > credentials_;
  ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::TrustedImageConfig > trusted_images_;
  ...
  friend struct ::protobuf_estafette_2fci_2fcontracts_2fv1_2fbuilder_5fconfig_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::estafette::ci::manifest::v1::EstafetteManifest& BuilderConfig::_internal_manifest() const {
  return *manifest_;
}
inline const ::estafette::ci::manifest::v1::EstafetteManifest& BuilderConfig::manifest() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::manifest::v1::EstafetteManifest*>(
...
inline const ::estafette::ci::contracts::v1::CiServerConfig& BuilderConfig::_internal_ci_server() const {
  return *ci_server_;
}
inline const ::estafette::ci::contracts::v1::CiServerConfig& BuilderConfig::ci_server() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::contracts::v1::CiServerConfig*>(
...
inline const ::estafette::ci::contracts::v1::BuildParamsConfig& BuilderConfig::_internal_build_params() const {
...
inline const ::estafette::ci::contracts::v1::BuildParamsConfig& BuilderConfig::build_params() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::contracts::v1::BuildParamsConfig*>(
...
inline const ::estafette::ci::contracts::v1::ReleaseParamsConfig& BuilderConfig::_internal_release_params() const {
...
inline const ::estafette::ci::contracts::v1::ReleaseParamsConfig& BuilderConfig::release_params() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::contracts::v1::ReleaseParamsConfig*>(
...
inline const ::estafette::ci::contracts::v1::GitConfig& BuilderConfig::_internal_git() const {
  return *git_;
}
inline const ::estafette::ci::contracts::v1::GitConfig& BuilderConfig::git() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::contracts::v1::GitConfig*>(
...
inline const ::estafette::ci::contracts::v1::BuildVersionConfig& BuilderConfig::_internal_build_version() const {
...
inline const ::estafette::ci::contracts::v1::BuildVersionConfig& BuilderConfig::build_version() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::estafette::ci::contracts::v1::BuildVersionConfig*>(
...
inline ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::CredentialConfig >*
...
inline const ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::CredentialConfig >&
...
inline ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::TrustedImageConfig >*
...
inline const ::google::protobuf::RepeatedPtrField< ::estafette::ci::contracts::v1::TrustedImageConfig >&
...
#endif  // PROTOBUF_INCLUDED_estafette_2fci_2fcontracts_2fv1_2fbuilder_5fconfig_2eproto
