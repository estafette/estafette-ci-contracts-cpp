...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseParamsConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseParamsConfig, release_name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseParamsConfig, release_id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseParamsConfig, release_action_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::estafette::ci::contracts::v1::ReleaseParamsConfig, triggered_by_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::estafette::ci::contracts::v1::_ReleaseParamsConfig_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "estafette/ci/contracts/v1/release_params_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "estafette/ci/contracts/v1/release_params_config.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* ReleaseParamsConfig::descriptor() {
  ::protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5fparams_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5fparams_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ReleaseParamsConfig& ReleaseParamsConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5fparams_5fconfig_2eproto::scc_info_ReleaseParamsConfig.base);
...
::google::protobuf::Metadata ReleaseParamsConfig::GetMetadata() const {
  protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5fparams_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_estafette_2fci_2fcontracts_2fv1_2frelease_5fparams_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::estafette::ci::contracts::v1::ReleaseParamsConfig* Arena::CreateMaybeMessage< ::estafette::ci::contracts::v1::ReleaseParamsConfig >(Arena* arena) {
