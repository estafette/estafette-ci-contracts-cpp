...
#ifndef PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fsemver_5fversion_2eproto
#define PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fsemver_5fversion_2eproto
...
#include "protos/manifest.v1/string_or_string_array.pb.h"
// @@protoc_insertion_point(includes)
#define PROTOBUF_INTERNAL_EXPORT_protobuf_protos_2fmanifest_2ev1_2festafette_5fsemver_5fversion_2eproto 
...
namespace google {
namespace protobuf {
template<> ::manifest::v1::EstafetteSemverVersion* Arena::CreateMaybeMessage<::manifest::v1::EstafetteSemverVersion>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace manifest {
namespace v1 {
...
class EstafetteSemverVersion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:manifest.v1.EstafetteSemverVersion) */ {
 public:
  ...
  private:
  const ::manifest::v1::StringOrStringArray& _internal_release_branch() const;
  public:
  const ::manifest::v1::StringOrStringArray& release_branch() const;
  ::manifest::v1::StringOrStringArray* release_release_branch();
  ::manifest::v1::StringOrStringArray* mutable_release_branch();
  void set_allocated_release_branch(::manifest::v1::StringOrStringArray* release_branch);
 ...
 private:
  ...
  ::manifest::v1::StringOrStringArray* release_branch_;
  ::google::protobuf::int64 major_;
  ::google::protobuf::int64 minor_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_protos_2fmanifest_2ev1_2festafette_5fsemver_5fversion_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int64 EstafetteSemverVersion::major() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteSemverVersion.major)
  return major_;
}
inline void EstafetteSemverVersion::set_major(::google::protobuf::int64 value) {
  
  major_ = value;
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteSemverVersion.major)
}
...
inline ::google::protobuf::int64 EstafetteSemverVersion::minor() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteSemverVersion.minor)
  return minor_;
}
inline void EstafetteSemverVersion::set_minor(::google::protobuf::int64 value) {
  
  minor_ = value;
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteSemverVersion.minor)
}
...
inline const ::std::string& EstafetteSemverVersion::patch() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteSemverVersion.patch)
...
inline void EstafetteSemverVersion::set_patch(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteSemverVersion.patch)
}
#if LANG_CXX11
inline void EstafetteSemverVersion::set_patch(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:manifest.v1.EstafetteSemverVersion.patch)
}
#endif
inline void EstafetteSemverVersion::set_patch(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:manifest.v1.EstafetteSemverVersion.patch)
}
inline void EstafetteSemverVersion::set_patch(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:manifest.v1.EstafetteSemverVersion.patch)
}
inline ::std::string* EstafetteSemverVersion::mutable_patch() {
  
  // @@protoc_insertion_point(field_mutable:manifest.v1.EstafetteSemverVersion.patch)
...
inline ::std::string* EstafetteSemverVersion::release_patch() {
  // @@protoc_insertion_point(field_release:manifest.v1.EstafetteSemverVersion.patch)
...
inline void EstafetteSemverVersion::set_allocated_patch(::std::string* patch) {
  ...
  // @@protoc_insertion_point(field_set_allocated:manifest.v1.EstafetteSemverVersion.patch)
}
...
inline const ::std::string& EstafetteSemverVersion::label_template() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteSemverVersion.label_template)
...
inline void EstafetteSemverVersion::set_label_template(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteSemverVersion.label_template)
}
#if LANG_CXX11
inline void EstafetteSemverVersion::set_label_template(::std::string&& value) {
  ...
  label_template_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:manifest.v1.EstafetteSemverVersion.label_template)
}
#endif
inline void EstafetteSemverVersion::set_label_template(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:manifest.v1.EstafetteSemverVersion.label_template)
}
inline void EstafetteSemverVersion::set_label_template(const char* value, size_t size) {
  ...
  label_template_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:manifest.v1.EstafetteSemverVersion.label_template)
}
inline ::std::string* EstafetteSemverVersion::mutable_label_template() {
  
  // @@protoc_insertion_point(field_mutable:manifest.v1.EstafetteSemverVersion.label_template)
...
inline ::std::string* EstafetteSemverVersion::release_label_template() {
  // @@protoc_insertion_point(field_release:manifest.v1.EstafetteSemverVersion.label_template)
...
inline void EstafetteSemverVersion::set_allocated_label_template(::std::string* label_template) {
  ...
  // @@protoc_insertion_point(field_set_allocated:manifest.v1.EstafetteSemverVersion.label_template)
}
...
inline const ::manifest::v1::StringOrStringArray& EstafetteSemverVersion::_internal_release_branch() const {
  return *release_branch_;
}
inline const ::manifest::v1::StringOrStringArray& EstafetteSemverVersion::release_branch() const {
  const ::manifest::v1::StringOrStringArray* p = release_branch_;
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteSemverVersion.release_branch)
  return p != NULL ? *p : *reinterpret_cast<const ::manifest::v1::StringOrStringArray*>(
      &::manifest::v1::_StringOrStringArray_default_instance_);
}
inline ::manifest::v1::StringOrStringArray* EstafetteSemverVersion::release_release_branch() {
  // @@protoc_insertion_point(field_release:manifest.v1.EstafetteSemverVersion.release_branch)
  
  ::manifest::v1::StringOrStringArray* temp = release_branch_;
  release_branch_ = NULL;
  return temp;
}
inline ::manifest::v1::StringOrStringArray* EstafetteSemverVersion::mutable_release_branch() {
  
  if (release_branch_ == NULL) {
    auto* p = CreateMaybeMessage<::manifest::v1::StringOrStringArray>(GetArenaNoVirtual());
    release_branch_ = p;
  }
  // @@protoc_insertion_point(field_mutable:manifest.v1.EstafetteSemverVersion.release_branch)
  return release_branch_;
}
inline void EstafetteSemverVersion::set_allocated_release_branch(::manifest::v1::StringOrStringArray* release_branch) {
  ...
  // @@protoc_insertion_point(field_set_allocated:manifest.v1.EstafetteSemverVersion.release_branch)
}
...
#endif  // PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fsemver_5fversion_2eproto
