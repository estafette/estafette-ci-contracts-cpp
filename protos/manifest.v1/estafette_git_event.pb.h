...
#ifndef PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fgit_5fevent_2eproto
#define PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fgit_5fevent_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_protos_2fmanifest_2ev1_2festafette_5fgit_5fevent_2eproto 
...
namespace google {
namespace protobuf {
template<> ::manifest::v1::EstafetteGitEvent* Arena::CreateMaybeMessage<::manifest::v1::EstafetteGitEvent>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace manifest {
namespace v1 {
...
class EstafetteGitEvent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:manifest.v1.EstafetteGitEvent) */ {
 public:
  EstafetteGitEvent();
 ...
 private:
  ...
  friend struct ::protobuf_protos_2fmanifest_2ev1_2festafette_5fgit_5fevent_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& EstafetteGitEvent::event() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteGitEvent.event)
...
inline void EstafetteGitEvent::set_event(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteGitEvent.event)
}
#if LANG_CXX11
inline void EstafetteGitEvent::set_event(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:manifest.v1.EstafetteGitEvent.event)
}
#endif
inline void EstafetteGitEvent::set_event(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:manifest.v1.EstafetteGitEvent.event)
}
inline void EstafetteGitEvent::set_event(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:manifest.v1.EstafetteGitEvent.event)
}
inline ::std::string* EstafetteGitEvent::mutable_event() {
  
  // @@protoc_insertion_point(field_mutable:manifest.v1.EstafetteGitEvent.event)
...
inline ::std::string* EstafetteGitEvent::release_event() {
  // @@protoc_insertion_point(field_release:manifest.v1.EstafetteGitEvent.event)
...
inline void EstafetteGitEvent::set_allocated_event(::std::string* event) {
  ...
  // @@protoc_insertion_point(field_set_allocated:manifest.v1.EstafetteGitEvent.event)
}
...
inline const ::std::string& EstafetteGitEvent::repository() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteGitEvent.repository)
...
inline void EstafetteGitEvent::set_repository(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteGitEvent.repository)
}
#if LANG_CXX11
inline void EstafetteGitEvent::set_repository(::std::string&& value) {
  ...
  repository_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:manifest.v1.EstafetteGitEvent.repository)
}
#endif
inline void EstafetteGitEvent::set_repository(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:manifest.v1.EstafetteGitEvent.repository)
}
inline void EstafetteGitEvent::set_repository(const char* value, size_t size) {
  ...
  repository_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:manifest.v1.EstafetteGitEvent.repository)
}
inline ::std::string* EstafetteGitEvent::mutable_repository() {
  
  // @@protoc_insertion_point(field_mutable:manifest.v1.EstafetteGitEvent.repository)
...
inline ::std::string* EstafetteGitEvent::release_repository() {
  // @@protoc_insertion_point(field_release:manifest.v1.EstafetteGitEvent.repository)
...
inline void EstafetteGitEvent::set_allocated_repository(::std::string* repository) {
  ...
  // @@protoc_insertion_point(field_set_allocated:manifest.v1.EstafetteGitEvent.repository)
}
...
inline const ::std::string& EstafetteGitEvent::branch() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteGitEvent.branch)
...
inline void EstafetteGitEvent::set_branch(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteGitEvent.branch)
}
#if LANG_CXX11
inline void EstafetteGitEvent::set_branch(::std::string&& value) {
  ...
  branch_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:manifest.v1.EstafetteGitEvent.branch)
}
#endif
inline void EstafetteGitEvent::set_branch(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:manifest.v1.EstafetteGitEvent.branch)
}
inline void EstafetteGitEvent::set_branch(const char* value, size_t size) {
  ...
  branch_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:manifest.v1.EstafetteGitEvent.branch)
}
inline ::std::string* EstafetteGitEvent::mutable_branch() {
  
  // @@protoc_insertion_point(field_mutable:manifest.v1.EstafetteGitEvent.branch)
...
inline ::std::string* EstafetteGitEvent::release_branch() {
  // @@protoc_insertion_point(field_release:manifest.v1.EstafetteGitEvent.branch)
...
inline void EstafetteGitEvent::set_allocated_branch(::std::string* branch) {
  ...
  // @@protoc_insertion_point(field_set_allocated:manifest.v1.EstafetteGitEvent.branch)
}
...
#endif  // PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fgit_5fevent_2eproto
