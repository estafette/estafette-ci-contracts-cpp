...
#ifndef PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fcron_5ftrigger_2eproto
#define PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fcron_5ftrigger_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_protos_2fmanifest_2ev1_2festafette_5fcron_5ftrigger_2eproto 
...
namespace google {
namespace protobuf {
template<> ::manifest::v1::EstafetteCronTrigger* Arena::CreateMaybeMessage<::manifest::v1::EstafetteCronTrigger>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace manifest {
namespace v1 {
...
class EstafetteCronTrigger : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:manifest.v1.EstafetteCronTrigger) */ {
 public:
 ...
 private:
  ...
  friend struct ::protobuf_protos_2fmanifest_2ev1_2festafette_5fcron_5ftrigger_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& EstafetteCronTrigger::schedule() const {
  // @@protoc_insertion_point(field_get:manifest.v1.EstafetteCronTrigger.schedule)
...
inline void EstafetteCronTrigger::set_schedule(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:manifest.v1.EstafetteCronTrigger.schedule)
}
#if LANG_CXX11
inline void EstafetteCronTrigger::set_schedule(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:manifest.v1.EstafetteCronTrigger.schedule)
}
#endif
inline void EstafetteCronTrigger::set_schedule(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:manifest.v1.EstafetteCronTrigger.schedule)
}
inline void EstafetteCronTrigger::set_schedule(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:manifest.v1.EstafetteCronTrigger.schedule)
}
inline ::std::string* EstafetteCronTrigger::mutable_schedule() {
  
  // @@protoc_insertion_point(field_mutable:manifest.v1.EstafetteCronTrigger.schedule)
...
inline ::std::string* EstafetteCronTrigger::release_schedule() {
  // @@protoc_insertion_point(field_release:manifest.v1.EstafetteCronTrigger.schedule)
...
inline void EstafetteCronTrigger::set_allocated_schedule(::std::string* schedule) {
  ...
  // @@protoc_insertion_point(field_set_allocated:manifest.v1.EstafetteCronTrigger.schedule)
}
...
#endif  // PROTOBUF_INCLUDED_protos_2fmanifest_2ev1_2festafette_5fcron_5ftrigger_2eproto
