...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "protos/manifest.v1/estafette_docker_trigger.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "protos/manifest.v1/estafette_docker_trigger.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* EstafetteDockerTrigger::descriptor() {
  ::protobuf_protos_2fmanifest_2ev1_2festafette_5fdocker_5ftrigger_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2festafette_5fdocker_5ftrigger_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const EstafetteDockerTrigger& EstafetteDockerTrigger::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_protos_2fmanifest_2ev1_2festafette_5fdocker_5ftrigger_2eproto::scc_info_EstafetteDockerTrigger.base);
...
::google::protobuf::Metadata EstafetteDockerTrigger::GetMetadata() const {
  protobuf_protos_2fmanifest_2ev1_2festafette_5fdocker_5ftrigger_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2festafette_5fdocker_5ftrigger_2eproto::file_level_metadata[kIndexInFileMessages];
}
