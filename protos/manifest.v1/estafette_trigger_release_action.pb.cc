...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "protos/manifest.v1/estafette_trigger_release_action.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "protos/manifest.v1/estafette_trigger_release_action.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* EstafetteTriggerReleaseAction::descriptor() {
  ::protobuf_protos_2fmanifest_2ev1_2festafette_5ftrigger_5frelease_5faction_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2festafette_5ftrigger_5frelease_5faction_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const EstafetteTriggerReleaseAction& EstafetteTriggerReleaseAction::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_protos_2fmanifest_2ev1_2festafette_5ftrigger_5frelease_5faction_2eproto::scc_info_EstafetteTriggerReleaseAction.base);
...
::google::protobuf::Metadata EstafetteTriggerReleaseAction::GetMetadata() const {
  protobuf_protos_2fmanifest_2ev1_2festafette_5ftrigger_5frelease_5faction_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2festafette_5ftrigger_5frelease_5faction_2eproto::file_level_metadata[kIndexInFileMessages];
}
