...
#include "protos/manifest.v1/estafette_pipeline_event.pb.h"
...
static void InitDefaultsEstafettePipelineEvent() {
  ...
  {
    void* ptr = &::manifest::v1::_EstafettePipelineEvent_default_instance_;
    new (ptr) ::manifest::v1::EstafettePipelineEvent();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::manifest::v1::EstafettePipelineEvent::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, build_version_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, repo_source_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, repo_owner_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, repo_name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, repo_branch_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, status_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::manifest::v1::EstafettePipelineEvent, event_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::manifest::v1::EstafettePipelineEvent)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::manifest::v1::_EstafettePipelineEvent_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "protos/manifest.v1/estafette_pipeline_event.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "protos/manifest.v1/estafette_pipeline_event.proto", &protobuf_RegisterTypes);
}
...
EstafettePipelineEvent::EstafettePipelineEvent()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_protos_2fmanifest_2ev1_2festafette_5fpipeline_5fevent_2eproto::scc_info_EstafettePipelineEvent.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:manifest.v1.EstafettePipelineEvent)
}
EstafettePipelineEvent::EstafettePipelineEvent(const EstafettePipelineEvent& from)
  ...
  // @@protoc_insertion_point(copy_constructor:manifest.v1.EstafettePipelineEvent)
}
...
EstafettePipelineEvent::~EstafettePipelineEvent() {
  // @@protoc_insertion_point(destructor:manifest.v1.EstafettePipelineEvent)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* EstafettePipelineEvent::descriptor() {
  ::protobuf_protos_2fmanifest_2ev1_2festafette_5fpipeline_5fevent_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2festafette_5fpipeline_5fevent_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const EstafettePipelineEvent& EstafettePipelineEvent::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_protos_2fmanifest_2ev1_2festafette_5fpipeline_5fevent_2eproto::scc_info_EstafettePipelineEvent.base);
  return *internal_default_instance();
}


void EstafettePipelineEvent::Clear() {
// @@protoc_insertion_point(message_clear_start:manifest.v1.EstafettePipelineEvent)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:manifest.v1.EstafettePipelineEvent)
  for (;;) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "manifest.v1.EstafettePipelineEvent.build_version"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "manifest.v1.EstafettePipelineEvent.repo_source"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "manifest.v1.EstafettePipelineEvent.repo_owner"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "manifest.v1.EstafettePipelineEvent.repo_name"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "manifest.v1.EstafettePipelineEvent.repo_branch"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 6: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "manifest.v1.EstafettePipelineEvent.status"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 7: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "manifest.v1.EstafettePipelineEvent.event"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:manifest.v1.EstafettePipelineEvent)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:manifest.v1.EstafettePipelineEvent)
  return false;
#undef DO_
}
...
void EstafettePipelineEvent::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:manifest.v1.EstafettePipelineEvent)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:manifest.v1.EstafettePipelineEvent)
}

::google::protobuf::uint8* EstafettePipelineEvent::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:manifest.v1.EstafettePipelineEvent)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:manifest.v1.EstafettePipelineEvent)
  return target;
}

size_t EstafettePipelineEvent::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:manifest.v1.EstafettePipelineEvent)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:manifest.v1.EstafettePipelineEvent)
  GOOGLE_DCHECK_NE(&from, this);
  const EstafettePipelineEvent* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const EstafettePipelineEvent>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:manifest.v1.EstafettePipelineEvent)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:manifest.v1.EstafettePipelineEvent)
    MergeFrom(*source);
  }
}

void EstafettePipelineEvent::MergeFrom(const EstafettePipelineEvent& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:manifest.v1.EstafettePipelineEvent)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:manifest.v1.EstafettePipelineEvent)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:manifest.v1.EstafettePipelineEvent)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata EstafettePipelineEvent::GetMetadata() const {
  protobuf_protos_2fmanifest_2ev1_2festafette_5fpipeline_5fevent_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2festafette_5fpipeline_5fevent_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::manifest::v1::EstafettePipelineEvent* Arena::CreateMaybeMessage< ::manifest::v1::EstafettePipelineEvent >(Arena* arena) {
  return Arena::CreateInternal< ::manifest::v1::EstafettePipelineEvent >(arena);
}
}  // namespace protobuf
}  // namespace google
