...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "protos/manifest.v1/string_or_string_array.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "protos/manifest.v1/string_or_string_array.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* StringOrStringArray::descriptor() {
  ::protobuf_protos_2fmanifest_2ev1_2fstring_5for_5fstring_5farray_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2fstring_5for_5fstring_5farray_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const StringOrStringArray& StringOrStringArray::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_protos_2fmanifest_2ev1_2fstring_5for_5fstring_5farray_2eproto::scc_info_StringOrStringArray.base);
...
::google::protobuf::Metadata StringOrStringArray::GetMetadata() const {
  protobuf_protos_2fmanifest_2ev1_2fstring_5for_5fstring_5farray_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fmanifest_2ev1_2fstring_5for_5fstring_5farray_2eproto::file_level_metadata[kIndexInFileMessages];
}
