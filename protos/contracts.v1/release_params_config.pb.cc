...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "protos/contracts.v1/release_params_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "protos/contracts.v1/release_params_config.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* ReleaseParamsConfig::descriptor() {
  ::protobuf_protos_2fcontracts_2ev1_2frelease_5fparams_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fcontracts_2ev1_2frelease_5fparams_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ReleaseParamsConfig& ReleaseParamsConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_protos_2fcontracts_2ev1_2frelease_5fparams_5fconfig_2eproto::scc_info_ReleaseParamsConfig.base);
...
::google::protobuf::Metadata ReleaseParamsConfig::GetMetadata() const {
  protobuf_protos_2fcontracts_2ev1_2frelease_5fparams_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_protos_2fcontracts_2ev1_2frelease_5fparams_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
